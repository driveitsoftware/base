...
class Login_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.id as userId, BaseTbl.password, BaseTbl.username as name, BaseTbl.roleId, BaseTbl.active, Roles.role');
    ...
    function createPasswordUser($email, $password)
    {
        $this->db->where('email', $email);
        $this->db->where('isDeleted', 0);
        $this->db->update('vendors', array('password'=>getHashedPassword($password)));
